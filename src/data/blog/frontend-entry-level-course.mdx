...
<h1>果果</h1>
<p>果果真可爱！</p>
<img src="https://placekitten.com/400/300"></img>
```
...
<CodeViewer
  ...
  html={`<h1>果果</h1>
<p>果果真可爱！</p>
<img src="https://placekitten.com/400/300" width="200"></img>`}
  css={`img {
  max-width: 100%;
  height: auto;
}`}
...
```HTML
<h1>果果</h1>
<p><a href="https://placekitten.com/800/600" target="_blank">果果</a>真可爱！</p>
```
...
<CodeViewer
  title="多个CSS规则应用"
  html={`<p class="bg-blue" id="guoguo">果果真可爱</p>
<h5 class="bg-blue">果果真可爱</h5>`}
  css={`p {
  color: red;
}
...
<CodeViewer
  title="多个class同时应用"
  html={`<p class="bg-blue red">果果真可爱</p>`}
  css={`.red {
  color: red
}
.bg-blue {
...
<CodeViewer
  title="CSS优先级：ID vs Class"
  html={`<p class="red" id="guoguo">果果真可爱</p>`}
  css={`.red {
  color: red
}
#guoguo {
...
<CodeViewer
  title="CSS继承"
  html={`<p class="red" id="guoguo"><span>果果</span>真可爱</p>`}
  css={`.red {
  color: red;
}`}
  defaultTab="html"
...
<CodeViewer
  ...
  html={`<p id="guoguo">果果真可爱</p>
<button onclick="changeColor()">改变颜色</button>
<button onclick="appendElement()">添加元素</button>
<div id="container"></div>`}
  js={`function changeColor() {
  const guoguo = document.getElementById('guoguo');
  guoguo.style.color = guoguo.style.color === 'red' ? 'black' : 'red';
}
